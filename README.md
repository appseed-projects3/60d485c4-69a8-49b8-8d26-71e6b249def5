...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-27 15:42`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/60d485c4-69a8-49b8-8d26-71e6b249def5.git
$ cd 60d485c4-69a8-49b8-8d26-71e6b249def5
```
